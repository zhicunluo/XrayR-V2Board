...
install_XrayR() {
    ...
    curl -o /usr/bin/XrayR -Ls https://cdn.jsdelivr.net/gh/zhicunluo/XrayR-V2Board/XrayR.sh
    ...
    # Writing json
    echo "正在尝试写入配置文件..."
    wget https://cdn.jsdelivr.net/gh/zhicunluo/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml
